...
?>
<header>
	<h2><?php esc_html_e( 'Forbundet Abonnement', 'woocommerce-subscriptions' ); ?></h2>
</header>
...
<table class="shop_table shop_table_responsive my_account_orders woocommerce-orders-table woocommerce-MyAccount-subscriptions woocommerce-orders-table--subscriptions">
	<thead>
		<tr>
			<th class="subscription-id order-number woocommerce-orders-table__header woocommerce-orders-table__header-order-number woocommerce-orders-table__header-subscription-id"><span class="nobr"><?php esc_html_e( 'Abonnement#', 'woocommerce-subscriptions' ); ?></span></th>
