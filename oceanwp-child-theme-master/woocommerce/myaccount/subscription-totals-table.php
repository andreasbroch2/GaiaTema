...
echo '<div id="id01" style="display:none;">';
$args = array(
    'category' => array( 'juice' ),
    'orderby'  => 'name',
);
...
<button onclick="document.getElementById('id01').style.display='block'" class="button" style="display:none">Open Modal</button>
