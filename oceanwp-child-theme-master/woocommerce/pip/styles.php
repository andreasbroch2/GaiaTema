...
@import url('https://fonts.googleapis.com/css2?family=Quicksand&display=swap');
	...
	body {
		display: block;
		font: normal <?php echo get_option( 'wc_pip_body_font_size', '12' ); ?>px/130% Quicksand, Arial, Helvetica, sans-serif;
}
	}
	...
	.container {
		margin: 1em auto;
		padding: 2em;
		background: url(https://gaiamadservice.dk/wp-content/uploads/2021/03/Folgeseddel.png);
