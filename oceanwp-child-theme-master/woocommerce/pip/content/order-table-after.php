...
<?php
					...
					<?php if ( $document->show_coupons_used() ) : ?>
						...
						<?php if ( $coupons && is_array( $coupons ) ) : ?>
							...
							printf( '<div class="coupons-used">' . _n( '%1$sRabatkode:%3$s %4$s', '%1$sCoupons used (%2$s):%3$s %4$s', count( $coupons ), 'woocommerce-pip' ) . '</div><br>', '<strong>', count( $coupons ), '</strong>', '<span class="coupon">' . implode( '</span>, <span class="coupon">', $coupons ) . '</span>' ); ?>
